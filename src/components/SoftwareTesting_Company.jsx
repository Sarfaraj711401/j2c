  ...
  return (
    <div className="white-section">
      ...
      <div className="counsellor-box">
        <p>
          Have doubts about Software Testing Placement Course? Get guidance from counsellors now.
        </p>
...
export default SoftwareTesting_Company;