...
const Supply_Chain_Logistics_Hero = () => {
    ...
    <section className="uiux-page">
      ...
      <section className="hero-section">
        ...
        <div className="hero-left">
          ...
          <h1>
            Supply Chain Logistics Placement Course with AI
            <span className="update-tag">Updated in may’ 25</span>
          </h1>

          <ul>
            <li>Get placed with ₹5-11 LPA salary</li>
            <li>Course fee refund if not placed</li>
          </ul>

          <div className="hero-card">
            <h3>3 months online course with LIVE sessions</h3>
            ...
            <div className="hero-card-box">
              ...
              <div className="hero-col">
                <p>Course Fee</p>
                <h2>
                  ₹25,999 <span className="strike">₹36,000</span>
                </h2>
                <span className="tag green">Save ₹ 10,001</span>
              </div>
            </div>
          </div>
...
export default Supply_Chain_Logistics_Hero;