  ...
  return (
    <div className="white-section">
      ...
      <div className="counsellor-box">
        <p>
          Have questions about the Data Science Placement Course? Our counsellors are here to help you every step of the way
        </p>
...
export default Data_Science_Company;