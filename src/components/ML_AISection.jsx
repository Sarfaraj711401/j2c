      ...
      <div className="ai-card">
        ...
        <div className="ai-text-block">
          ...
          <p className="ai-description">
            The AI tools taught in the course will help you get ahead in your career by enabling you to work with real-world data, build intelligent models, and automate decision-making processes. These tools improve your ability to analyze problems, develop practical solutions.
          </p>
