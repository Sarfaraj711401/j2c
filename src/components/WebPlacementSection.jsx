      ...
      <div className="placement-card">
        ...
        <div className="placement-text-block">
          <h2 className="placement-title">
            What placement support will you receive?
          </h2>
          ...
          <div className="benefit-block">
            ...
            <p className="benefit-text">
              Your internships and jobs will be highlighted in internship and
              job applications.
            </p>
          </div>
        </div>
...
export default WebPlacementSection;