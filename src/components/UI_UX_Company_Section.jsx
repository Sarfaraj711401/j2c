  ...
  return (
    <div className="white-section">
      ...
      <div className="counsellor-box">
        <p>
          Have questions about the UI/UX Designer Course? Our counsellors are here to help you every step of the way
        </p>
      ...
      <div className="stats-box">
        ...
        <div className="stat">
          <h3>700+</h3>
          <p>UI/UX Designer internships</p>
        </div>
      </div>
...
export default UI_UX_Company_Section;