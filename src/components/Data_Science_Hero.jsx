    ...
    <section className="uiux-page">
      <section className="hero-section">
        ...
        <div className="hero-left">
          ...
          <h1>
            Data Science Placement Course with AI
            <span className="update-tag">Updated in Jan’ 12</span>
          </h1>
          ...
          <div className="hero-card">
            ...
            <div className="hero-card-box">
              ...
              <div className="hero-col">
                <p>Course Fee</p>
                <h2>
                  ₹38,999 <span className="strike">₹45,000</span>
                </h2>
                <span className="tag green">Save ₹ 6,001</span>
              </div>
            </div>
          </div>
...
export default Data_Science_Hero;