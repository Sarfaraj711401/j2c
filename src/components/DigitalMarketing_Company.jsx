...
const DigitalMarketing_Company = () => {
  return (
    <div className="white-section">
      ...
      <div className="counsellor-box">
        <p>
          Have questions about the Digital Marketing Management Placement Course? Our counsellors are here to help you every step of the way
        </p>
      ...
      <div className="stats-box">
        ...
        <div className="stat">
          <h3>1100+</h3>
          <p>Digital Marketing internships</p>
        </div>
      </div>
...
export default DigitalMarketing_Company;