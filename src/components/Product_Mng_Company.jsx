  ...
  return (
    <div className="white-section">
      ...
      <div className="counsellor-box">
        <p>
          Have questions about the Product Management Placement Course? Our counsellors are here to help you every step of the way
        </p>
      ...
      <div className="stats-box">
        ...
        <div className="stat">
          <h3>2500+</h3>
          <p>Product Management internships</p>
        </div>
      </div>
...
export default Product_Mng_Company;