    ...
    <section className="uiux-page">
      ...
      <section className="hero-section">
        ...
        <div className="hero-left">
          ...
          <h1>
            Software Testing Placement Course with AI
            <span className="update-tag">Updated in Dec’ 25</span>
          </h1>
          ...
          <div className="hero-card">
            ...
            <div className="hero-card-box">
              ...
              <div className="hero-col">
                <p>Course Fee</p>
                <h2>
                  ₹35,999 <span className="strike">₹46,000</span>
                </h2>
...
export default SoftwareTesting_Hero;