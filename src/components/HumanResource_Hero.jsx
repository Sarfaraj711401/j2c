    ...
    <section className="uiux-page">
      ...
      <section className="hero-section">
        ...
        <div className="hero-left">
          ...
          <h1>
            Human Resource Placement Course with AI
            <span className="update-tag">Updated in Dec’ 28</span>
          </h1>

          <ul>
            <li>Get placed with ₹5-10 LPA salary</li>
          ...
          <div className="hero-card">
            ...
            <div className="hero-card-box">
              ...
              <div className="hero-col">
                <p>Course Fee</p>
                <h2>
                  ₹30,999 <span className="strike">₹40,000</span>
                </h2>
                <span className="tag green">Save ₹ 9,001</span>
              </div>
            </div>
          </div>
...
export default HumanResource_Hero;