...
const FinancialModeling_Company = () => {
  return (
    <div className="white-section">
      ...
      <div className="counsellor-box">
        <p>
          Have doubts about Financial Modeling Placement Course? Get guidance from counsellors now.
        </p>
...
export default FinancialModeling_Company;